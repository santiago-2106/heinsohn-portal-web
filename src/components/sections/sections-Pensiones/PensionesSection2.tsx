  ...
  return (
    <section>
      <CertificacionesInternacionales
        ...
        imagen="/img/certificaciones.png"
      />
      <div className="mt-5">
        <p className="text-gray-500 text-center text-2xl mb-5">
          Sin compromiso | Respaldo en <span className="text-red-500">+</span>7
          Paises | <span className="text-red-500">+</span>12 millones de
          afiliados administrativos
        </p>
      </div>
      <div>
        <TextComponent
