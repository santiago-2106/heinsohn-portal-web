...
// ELIMINADO: import ImgIa from "@/src/img/imgIAgestionHumana.jpg";
import {
        ...
        <article className="mt-10 mb-10 w-full max-w-4xl mx-auto px-4">
          ...
          <div className="relative mt-12 overflow-hidden cursor-pointer">
            <div className="relative aspect-video w-full">
              <Image
                src="/img/imgIAgestionHumana.jpg" /* <-- RUTA CORREGIDA A PUBLIC */
            ...
            <div className="bg-black text-white py-12 px-6 text-center">
              <p className="text-lg md:text-xl font-light mb-4 text-gray-500">
