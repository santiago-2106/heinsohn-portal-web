export default function SubcomponenteCardStaff({
  information,
}: staffArgumentationProps) {
  return (
              ...
              >
                ...
                <div className="flex-1 rounded-sm border border-gray-200 bg-white p-6  md:flex md:items-center md:gap-10">
                  <div className="flex flex-col items-start min-w-20">
                    <span className="text-[10px] uppercase font-bold text-gray-900 tracking-widest mb-1">
                      {info.fase}
                    </span>
                    <span className="text-3xl font-light tracking-tighter text-red-500">
                      {info.indicador}
                    </span>
                  </div>
