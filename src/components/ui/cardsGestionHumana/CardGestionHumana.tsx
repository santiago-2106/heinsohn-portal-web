...
export default function CardGestionHumana({ 
  ...
  return (
    ...
    <section className="relative flex flex-col border border-gray-200 bg-white p-8 md:p-10 hover:shadow-lg transition-shadow duration-300 h-full">
      ...
      {btnText && (
        <a href="#" className="mt-auto group flex items-center justify-between w-max gap-4 border border-gray-200 rounded-full px-6 py-2.5 text-sm font-semibold text-gray-700 hover:border-gray-400 transition-colors">
          {btnText} 
