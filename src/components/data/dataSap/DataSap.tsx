...
const TestIcons = {
  building: (
    ...
    >
      ...
      <rect x="9" y="4" width="6" height="16"></rect>
...
export const dataSAP = {
    ...
    description: (
      <div className="flex flex-col gap-8 w-full">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-light text-gray-500 leading-snug">
          Elige el ERP ideal para tu empresa y recibe una cotización
          personalizada
        </h2>
        <p className="text-base md:text-lg text-gray-500 font-light leading-relaxed text-justify md:text-left">
          SAP Business One centraliza finanzas, inventarios, producción y ventas
          en un ERP flexible y escalable, apoyado por un ecosistema completo de
          nómina, gestión humana y cumplimiento legal, que impulsa la eficiencia
          operativa y el crecimiento del negocio.{" "}
    ...
    cards: [
      {
        ...
        description:
          "generación directa de órdenes en SAP desde archivos Excel, reduciendo errores y tiempos de digitación.",
      },
      {
        icon: CardIcons.bubbles,
        title: "Procesamiento masivo de facturación",
        description:
          "generación automática de facturas desde remisiones creadas en SAP y envío a la DIAN.",
      },
      {
        icon: CardIcons.stars,
        title: "Procesamiento masivo de pagos recibidos",
        description:
          "creación automática de pagos con base en archivos bancarios.",
      },
      {
        icon: CardIcons.bot,
        title: "Gestión inteligente de cartera",
        description:
          "uso de eventos de aceptación y/o rechazo por parte del receptor para optimizar el control y seguimiento de facturas.",
      },
    ],
  },
  ...
  testSection: {
    ...
    cards: [
      {
        icon: TestIcons.building,
        contenedor: "Para pequeñas empresas",
        title: "ERP Heinsohn Lite",
        subTitle: "Desde 1-10 licencias",
        description:
          "Solución ERP diseñada específicamente para pequeñas empresas que buscan digitalizar sus procesos de manera simple y efectiva.",
        items: [
      ...
      {
        badge: "Más popular",
        icon: TestIcons.house,
        contenedor: "Para empresas medianas",
        title: "ERP SAP Business One",
        subTitle: "Desde 5 licencias",
        description:
          "ERP completo de SAP que ofrece funcionalidades avanzadas para empresas que necesitan mayor integración y control.",
        items: [
      ...
      },
      {
        ...
        description:
          "La suite más avanzada de SAP para empresas que requieren máxima potencia, flexibilidad y capacidades de IA.",
        items: [
  ...
  erpComparisonSection: {
    ...
    description: (
      <div className="flex flex-col gap-1">
        <span>
          Transformaciones reales que han revolucionado industrias completas a
          través de soluciones tecnológicas innovadoras.
        </span>
        <span>No es lo mismo operar con 20 empleados que con 200.</span>
        <span>
          Por eso, Heinsohn tiene 3 soluciones de ERP distintas para cada etapa
          del crecimiento:
        </span>
      </div>
    ) as any,
    cards: [
      ...
      {
        icon: TestIcons.house,
        title: "SAP Bus321 iness One ERP",
        description:
          "Pensado para empresas medianas que quieren integrar todas sus áreas.",
        alineacion: "center",
      },
      {
        icon: TestIcons.cart,
        ...
        description:
          "Para empresas en crecimiento que necesitan nube, IA y escalabilidad regional.",
        alineacion: "center",
      },
    ] as dataCard[],
  },
  ...
  partnerSection: {
    ...
    cards: [
      {
        icon: PartnerIcons.diamond,
        badgeRight: "Certificación oficial",
        title: "SAP Gold Partner",
        description: (
          <>
            Certificación oficial que garantiza expertise y mejores prácticas en{" "}
      ...
      },
      {
        ...
        description: (
          <>
            ...
            con soporte en español y conocimiento del mercado local.
          </>
        ) as any,
      },
      {
        icon: PartnerIcons.leaf,
        badgeRight: "Experiencia sectorial",
        title: "+15 industrias",
        description: (
          <>
            <strong className="font-semibold text-gray-900">Experiencia</strong>{" "}
            comprobada en manufactura, retail, servicios, salud, educación y más
            sectores.
          </>
        ) as any,
      },
      {
        icon: PartnerIcons.globe,
        badgeRight: "Desde 1979",
        title: "Aliado estratégico",
        description: (
          <>
            Trayectoria sólida acompañando la transformación digital de empresas
            en{" "}
            <strong className="font-semibold text-gray-900">
              toda Latinoamérica.
            </strong>
    ...
    cards: [
      {
        ...
        description:
          "Propuesta detallada con precios, tiempos de implementación y beneficios específicos para tu empresa.",
      },
      {
        icon: createNumberIcon("02", "Contenido premium"),
        title: "Guía descargable",
        description:
          "Material exclusivo con mejores prácticas, casos de éxito y roadmap de implementación para tu industria.",
      },
      {
        icon: createNumberIcon("03", "Demo personalizada"),
        title: "Oportunidad de demo",
        description:
          "Demostración personalizada del ERP recomendado con escenarios reales de tu tipo de negocio.",
      },
      {
        icon: createNumberIcon("04", "Sin compromiso"),
        title: "Consultoría gratuita",
        description:
          "Sesión de 30 minutos con un especialista SAP para resolver dudas y planificar la implementación.",
      },
    ],
  },
};
