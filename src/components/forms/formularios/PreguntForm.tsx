  ...
  return (
    <div className="border-b border-gray-200 last:border-0">
      ...
      >
        {/* Pregunta */}
        <span
          className={`text-lg sm:text-xl font-light pr-8 transition-colors duration-300 ${isOpen ? "text-[#E30613]" : "text-gray-600 group-hover:text-gray-900"}`}
        >
          {question}
        </span>
        ...
        {/* Flecha Roja */}
        <span
          className={`text-[#E30613] transform transition-transform duration-300 ${isOpen ? "rotate-180" : "rotate-0"}`}
        >
