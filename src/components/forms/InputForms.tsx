  ...
  return (
    <div className="relative">
      <input
        id={id}
        placeholder={label}
        className="peer w-full border-0 border-gray-500 border-b bg-transparent px-0 py-2 text-text-body placeholder-transparent focus:outline-none focus:ring-0 transition-colors"
        {...formregister}
        {...props}
      />
