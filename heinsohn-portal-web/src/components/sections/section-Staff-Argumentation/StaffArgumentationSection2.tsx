import { dataIA, infoStaffArgumentation2, infoStaffArgumentation4, infoStaffArgumentation5, infoStaffArgumentation6 } from "../../data/dataStaffArgumentation/dataStaffArgumentation";
   ...
   <section>
    <section>
      ...
      <article className="mx-auto max-w-4xl grid grid-cols-1 p-5 md:grid-cols-2 gap-8 py-16">  
        {
          infoStaffArgumentation4.map((i, index) => (
            <Card key={index} {...i} />
          ))
        }
      </article>
    ...
    <section>
     ...
     <article className="mt-24"> {/*REVISAR PARA USAR ESTILOS GLOBALES  */}
      <TextComponent 
